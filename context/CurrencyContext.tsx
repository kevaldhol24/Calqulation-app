...
import { CurrencyOption, currencyUtils, getDefaultCurrency, createCurrencyCookieScript } from '../utils/currencyManager';
...
export const CurrencyProvider: React.FC<CurrencyProviderProps> = ({ children }) => {
  const [selectedCurrency, setSelectedCurrency] = useState<CurrencyOption>(getDefaultCurrency());
