...
export default function PersonalLoanCalculatorScreen() {
  ...
  const handleWebViewError = () => {
    setIsLoading(false);
    setError('Failed to load Personal Loan Calculator. Please check your internet connection.');
  };
      ...
      {error ? (
        ...
        <>
          <WebView
            ref={webViewRef}
            source={{ 
              uri: WEBVIEW_URLS.PERSONAL_LOAN_CALCULATOR,
            ...
            renderLoading={() => (
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.loadingText}>Loading Personal Loan Calculator...</Text>
              </View>
            )}
          />
