...
export default function OfflineEMICalculatorScreen() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={["bottom"]}>
      <ToolHeader title="Offline EMI Calculator" icon="calculator" />
          ...
          <View style={styles.infoContainer}>
            ...
            >
              ...
              <Text style={styles.infoText}>
                This offline calculator provides a basic EMI estimate. For
                detailed analysis, use the Advanced EMI Calculator.
              </Text>
            </LinearGradient>
          </View>
            ...
            >
              ...
              >
                ...
                <View style={styles.resultRow}>
                  ...
                  <Text style={styles.resultValue}>
                    {symbol}{" "}
                    {totalInterest ? formatCurrency(totalInterest) : "0.00"}
                  </Text>
                </View>
