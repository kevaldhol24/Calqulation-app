...
export default function CarLoanCalculatorScreen() {
  ...
  const handleWebViewError = () => {
    setIsLoading(false);
    setError('Failed to load Car Loan Calculator. Please check your internet connection.');
  };
      ...
      {error ? (
        ...
        <>
          <WebView
            ref={webViewRef}
            source={{ 
              uri: WEBVIEW_URLS.CAR_LOAN_CALCULATOR,
            ...
            renderLoading={() => (
              <View style={styles.loadingContainer}>
                ...
                <Text style={styles.loadingText}>Loading Car Loan Calculator...</Text>
              </View>
            )}
          />
